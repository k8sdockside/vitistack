...
(() => {
  ...
  function meter(used, total, opts = {}) {
    ...
    const bar2 = el("span", "meter-bar");
    const fill = el("i", "meter-fill " + tone);
    fill.style.width = `${Math.round(ratio * 100)}%`;
    bar2.appendChild(fill);
    add(node, bar2, opts.text !== void 0 ? el("span", "meter-text", opts.text) : null);
  ...
  function staticPoolSize(cidr, start, end) {
